                ...
                begin
                    ...
                    Packaging::Config.architectures.each do |requested_architecture, allowed_distributions|
                        allowed_distributions.each do |release|
                            ...
                            if Apaka::Packaging::Config.linux_distribution_releases.has_key?(release)
                                package_info_ask.operating_system = Apaka::Packaging::Config.linux_distribution_releases[ release ]
                            else
