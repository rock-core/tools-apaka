...
#                                        end
#                                        patch_options =@patch_options.dup
#                                        patch_options[:install_dir] = install_dir
...
#                            package_name = options[:package_name] || gem_base_name
#                            if patch_pkg_dir(package_name, options[:patch_dir], -> @patch_options options: { install_dir: install_dir})
